...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if is_vip or usuarios[user_id]['token_valido']:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("Acesse Canais FREE🎁", url='https://t.me/addlist/ChUSqdw-4LBiMzJh')],
            [InlineKeyboardButton("Acesse Grupo de Bate-Papo!📲", url='https://t.me/batepapogerador')],
            [InlineKeyboardButton("💰Comprar seu Plano Mensal ou Anual aqui!", url='https://t.me/Desbloqueie_Seu_Gerador_Bot')]
        ]
        ...
        keyboard = [
            [InlineKeyboardButton("Peça seu Teste GRATUITO", url='https://t.me/BLISSSUPORTE')],
            [InlineKeyboardButton("Acesse Canais FREE 🎁", url='https://t.me/addlist/ChUSqdw-4LBiMzJh')],
            [InlineKeyboardButton("Acesse Grupo de Bate-Papo!📲", url='https://t.me/batepapogerador')],
            [InlineKeyboardButton("💰Comprar seu Plano Mensal ou Anual aqui!", url='https://t.me/Desbloqueie_Seu_Gerador_Bot')]
        ]
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if query.data == 'teste_gratuito':
        if not usuarios[user_id].get('teste_inicio'):  # Verifica se o teste já começou
            ...
            keyboard = [
                [InlineKeyboardButton("🔸Gere Sua LISTA AQUI!🔸", callback_data='voltar')],
                [InlineKeyboardButton("Duvidas e Suporte📥", url='https://t.me/djc_geradorpro')]
            ]
